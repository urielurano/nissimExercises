...
def make_SplinePlot():
    ...
    try:
            ...
            X,Y, X_izq, X_der, Y_arr, Y_aba = loadtxt('/home/antonio/nissimExercises/NGC1275/FERMI.dat', unpack = True)
            X1,Y1, X1_izq, X1_der, Y1_arr, Y1_aba = loadtxt('/home/antonio/nissimExercises/NGC1275/magic.dat', unpack = True)
            X2,Y2, X2_izq, X2_der, Y2_arr, Y2_aba = loadtxt('/home/antonio/nissimExercises/NGC1275/MisuMe.dat', unpack = True)
            X3,Y3, X3_izq, X3_der, Y3_arr, Y3_aba = loadtxt('/home/antonio/nissimExercises/NGC1275/mojave.dat', unpack = True)
            X4,Y4, X4_izq, X4_der, Y4_arr, Y4_aba = loadtxt('/home/antonio/nissimExercises/NGC1275/ratan.dat', unpack = True)
            X5,Y5, X5_izq, X5_der, Y5_arr, Y5_aba = loadtxt('/home/antonio/nissimExercises/NGC1275/Swift_uvot.dat', unpack = True)
            X6,Y6, X6_izq, X6_der, Y6_arr, Y6_aba= loadtxt('/home/antonio/nissimExercises/NGC1275/unkown.dat', unpack = True)
...
def makeFit(files):
    ...
    try:
        ...
        path = '/home/antonio/nissimExercises/PSK0447-439/points/'
        i = 0;
        while(i < len(files)):
...
def _showMathPlotlib():
    ...
    X,Y, X_izq, X_der, Y_arr, Y_aba = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/atom.dat', unpack = True)
    X1,Y1, X1_izq, X1_der, Y1_arr, Y1_aba = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/fermi.dat', unpack = True)
    X2,Y2, X2_izq, X2_der, Y2_arr, Y2_aba = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/hess.dat', unpack = True)
    X3,Y3, X3_izq, X3_der, Y3_arr, Y3_aba = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/ned.dat', unpack = True)
    X4,Y4, X4_izq, X4_der, Y4_arr, Y4_aba = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/uvot.dat', unpack = True)
    X5,Y5, X5_izq, X5_der, Y5_arr, Y5_aba = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/xrt.dat', unpack = True)
    
    #XS, YS = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/syn.dat', unpack = True)
    #XC, YC = loadtxt('/home/antonio/nissimExercises/PSK0447-439/points/comp.dat', unpack = True)
