...
Float_t cc = 10;
 ...
 //fun4 = new TF1("fun4"," [0]*(((1e-1/p0)^(-0.5)*(x/p0)^(4/3)*(5e-4/p0)**((3-[1])/2)*(x>1e-6)*(x<5e-4))+((1e-1/p1)^(-0.5)*(x/p1)**((3-[1])/2)*(x>=5e-4)*(x<1e-1)) + ((x/p2)**((2-[1])/2))*(x>=1e-1)*(x<10))", 1e-6,100); //pgamma interaction
